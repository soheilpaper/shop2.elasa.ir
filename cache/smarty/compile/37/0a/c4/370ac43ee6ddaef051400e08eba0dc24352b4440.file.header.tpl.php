<?php /* Smarty version Smarty-3.1.19, created on 2015-09-08 23:26:19
         compiled from "/var/lib/openshift/55e37f347628e110a30000f4/app-root/data/current/themes/pos_bstore1/header.tpl" */ ?>
<?php /*%%SmartyHeaderCode:25192352955ef2f53cb1a61-59574529%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '370ac43ee6ddaef051400e08eba0dc24352b4440' => 
    array (
      0 => '/var/lib/openshift/55e37f347628e110a30000f4/app-root/data/current/themes/pos_bstore1/header.tpl',
      1 => 1440995888,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '25192352955ef2f53cb1a61-59574529',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_55ef2f53e03f20_55643772',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55ef2f53e03f20_55643772')) {function content_55ef2f53e03f20_55643772($_smarty_tpl) {?><?php if (!is_callable('smarty_function_implode')) include '/var/lib/openshift/55e37f347628e110a30000f4/app-root/data/current/tools/smarty/plugins/function.implode.php';
?>
<!DOCTYPE HTML>
...
owl.carousel.min.js"></script>
		<link href='http<?php if (Tools::usingSecureMode()) {?>s<?php }?>://fonts.googleapis.com/css?family=Bitter:400,700,400italic&amp;subset=latin,latin-ext' rel='stylesheet' type='text/css'>
		<link href='http<?php if (Tools::usingSecureMode()) {?>s<?php }?>://fonts.googleapis.com/css?family=Oswald:400,300,700&amp;subset=latin,latin-ext' rel='stylesheet' type='text/css'>
			...
			<div class="header-container">
				<header id="header">
					...
					<div class="ontop_center">
						<div class="container">
							<div class="">
<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['hook'][0][0]->smartyHook(array('h'=>"googlePlusOne"),$_smarty_tpl);?>
...
"<?php }?>/>
								...
								<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['hook'][0][0]->smartyHook(array('h'=>"searchcategory"),$_smarty_tpl);?>
...
<?php }?>
			...
			<?php if ($_smarty_tpl->tpl_vars['page_name']->value=='index') {?>
				<div class="home-container">
					...
					<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['hook'][0][0]->smartyHook(array('h'=>"productExtraRight"),$_smarty_tpl);?>
