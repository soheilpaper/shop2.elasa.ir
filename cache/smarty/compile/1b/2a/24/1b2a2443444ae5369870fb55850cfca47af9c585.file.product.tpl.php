<?php /* Smarty version Smarty-3.1.19, created on 2015-09-09 04:13:29
         compiled from "/var/lib/openshift/55e37f347628e110a30000f4/app-root/data/current/themes/pos_bstore1/product.tpl" */ ?>
<?php /*%%SmartyHeaderCode:207729182455ef72a132a064-26186234%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1b2a2443444ae5369870fb55850cfca47af9c585' => 
    array (
      0 => '/var/lib/openshift/55e37f347628e110a30000f4/app-root/data/current/themes/pos_bstore1/product.tpl',
      1 => 1441336078,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '207729182455ef72a132a064-26186234',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_55ef72a2610c12_62619644',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55ef72a2610c12_62619644')) {function content_55ef72a2610c12_62619644($_smarty_tpl) {?><?php if (!is_callable('smarty_function_math')) include '/var/lib/openshift/55e37f347628e110a30000f4/app-root/data/current/tools/smarty/plugins/function.math.php';
if (!is_callable('smarty_modifier_date_format')) include '/var/lib/openshift/55e37f347628e110a30000f4/app-root/data/current/tools/smarty/plugins/modifier.date_format.php';
if (!is_callable('smarty_function_cycle')) include '/var/lib/openshift/55e37f347628e110a30000f4/app-root/data/current/tools/smarty/plugins/function.cycle.php';
if (!is_callable('smarty_function_counter')) include '/var/lib/openshift/55e37f347628e110a30000f4/app-root/data/current/tools/smarty/plugins/function.counter.php';
?>
...
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['packItem']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
			...
			<p id="availability_statut"<?php if (!$_smarty_tpl->tpl_vars['PS_STOCK_MANAGEMENT']->value||($_smarty_tpl->tpl_vars['product']->value->quantity<=0&&!$_smarty_tpl->tpl_vars['product']->value->available_later&&$_smarty_tpl->tpl_vars['allow_oosp']->value)||($_smarty_tpl->tpl_vars['product']->value->quantity>0&&!$_smarty_tpl->tpl_vars['product']->value->available_now)||!$_smarty_tpl->tpl_vars['product']->value->available_for_order||$_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value) {?> style="display: none;"<?php }?>>
				...
				<span id="availability_value" class="label<?php if ($_smarty_tpl->tpl_vars['product']->value->quantity<=0&&!$_smarty_tpl->tpl_vars['allow_oosp']->value) {?> label-danger<?php } elseif ($_smarty_tpl->tpl_vars['product']->value->quantity<=0) {?> label-warning<?php } else { ?> label-success<?php }?>"  style="visibility: hidden; max-width: 1%;visibility: hidden;position: absolute;"><?php if ($_smarty_tpl->tpl_vars['product']->value->quantity<=0) {?><?php if ($_smarty_tpl->tpl_vars['PS_STOCK_MANAGEMENT']->value&&$_smarty_tpl->tpl_vars['allow_oosp']->value) {?><?php echo $_smarty_tpl->tpl_vars['product']->value->available_later;?>
<?php } else { ?><?php echo smartyTranslate(array('s'=>'This product is no longer in stock'),$_smarty_tpl);?>
<?php }?><?php } elseif ($_smarty_tpl->tpl_vars['PS_STOCK_MANAGEMENT']->value) {?> if}<?php echo smartyTranslate(array('s'=>' '),$_smarty_tpl);?>
<?php }?></span>
...
<?php } else { ?><?php echo smartyTranslate(array('s'=>'This product is no longer in stock'),$_smarty_tpl);?>
<?php }?><?php } elseif ($_smarty_tpl->tpl_vars['PS_STOCK_MANAGEMENT']->value) {?><?php echo smartyTranslate(array('s'=>'In stock'),$_smarty_tpl);?>
<?php }?></span>
              </p>
...
<?php }?>
			...
			<?php }?>
			<?php if ((!isset($_smarty_tpl->tpl_vars['restricted_country_mode']->value))||isset($_smarty_tpl->tpl_vars['groups']->value)||$_smarty_tpl->tpl_vars['product']->value->reference||(isset($_smarty_tpl->tpl_vars['HOOK_PRODUCT_ACTIONS']->value)&&$_smarty_tpl->tpl_vars['HOOK_PRODUCT_ACTIONS']->value)) {?>
			<!-- add to cart form-->
...
<?php }?></span>
	...
	<div class="col-xs-12">
		<ul id="more_info_tabs" class="idTabs idTabsShort clearfix">
			...
			<?php if ($_smarty_tpl->tpl_vars['features']->value) {?><li><a id="more_info_tab_data_sheet" href="#idTab2"><span><?php echo smartyTranslate(array('s'=>'Data sheet'),$_smarty_tpl);?>
</span></a></li><?php }?>
			<?php if ($_smarty_tpl->tpl_vars['attachments']->value) {?><li><a id="more_info_tab_attachments" href="#idTab9"><span><?php echo smartyTranslate(array('s'=>'Download'),$_smarty_tpl);?>
</span></a></li><?php }?>
			<?php if (isset($_smarty_tpl->tpl_vars['accessories']->value)&&$_smarty_tpl->tpl_vars['accessories']->value) {?><li><a href="#idTab4"><span><?php echo smartyTranslate(array('s'=>'Accessories'),$_smarty_tpl);?>
</span></a></li><?php }?>
			<?php if (isset($_smarty_tpl->tpl_vars['product']->value)&&$_smarty_tpl->tpl_vars['product']->value->customizable) {?><li><a href="#idTab10"><span><?php echo smartyTranslate(array('s'=>'Product customization'),$_smarty_tpl);?>
</span></a></li><?php }?>
			<?php if (isset($_smarty_tpl->tpl_vars['HOOK_PRODUCT_TAB_CONTENT']->value)&&$_smarty_tpl->tpl_vars['HOOK_PRODUCT_TAB_CONTENT']->value) {?><?php echo $_smarty_tpl->tpl_vars['HOOK_PRODUCT_TAB']->value;?>
<?php }?>
		</ul>
	</div>
	<div class="col-xs-12">
...
?>
									<?php if (($_smarty_tpl->tpl_vars['accessory']->value['allow_oosp']||$_smarty_tpl->tpl_vars['accessory']->value['quantity_all_versions']>0||$_smarty_tpl->tpl_vars['accessory']->value['quantity']>0)&&$_smarty_tpl->tpl_vars['accessory']->value['available_for_order']&&!isset($_smarty_tpl->tpl_vars['restricted_country_mode']->value)) {?>
										...
										<div class="item product_accessories_description">
