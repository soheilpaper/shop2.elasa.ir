...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_56002f82da2072_59013265',
  'has_nocache_code' => false,
  'cache_lifetime' => 31536000,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_56002f82da2072_59013265')) {function content_56002f82da2072_59013265($_smarty_tpl) {?>
        ...
        <input type="hidden" name="orderway" value="desc" />
			<div class="pos_search form-group">
					 ...
					 <option value="">شاخه ها</option>
                        <option value="3">--نازل آبنما </option><option value="5">---نازل رقص شیطان </option><option value="12">--واتر پمپ آبنما </option><option value="27">---پمپ سانتری فیوژ </option><option value="13">--پروژکتور LED </option><option value="26">--نورپردازی  </option>
                    </select>
                            </div>
