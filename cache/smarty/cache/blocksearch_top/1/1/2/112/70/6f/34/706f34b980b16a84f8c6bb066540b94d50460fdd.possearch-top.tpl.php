...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_55ef4d2d0b8de8_98979719',
  'has_nocache_code' => false,
  'cache_lifetime' => 31536000,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55ef4d2d0b8de8_98979719')) {function content_55ef4d2d0b8de8_98979719($_smarty_tpl) {?>
        ...
        <input type="hidden" name="orderway" value="desc" />
			<div class="pos_search form-group">
					 ...
					 <option value="">Categories</option>
                        <option value="3">--Women </option><option value="5">---T-shirts </option><option value="12">--Men </option><option value="27">---پمپ سانتری فیوژ </option><option value="13">--clothing </option><option value="26">--kids </option>
                    </select>
                            </div>
