...
class posspecialsproducts extends Module
{
	...
	function install()
	{
		if (!Configuration::updateValue('SPECIAL_PRODUCTS_NBR', 5) OR !parent::install() OR !$this->registerHook('blockPosition3') OR !$this->registerHook('header'))
			return false;
		return true;
	}
	...
	function hookBlockPosition5($params)
	{
	global $smarty;
    global $cookie;
        $category = new Category(1);
