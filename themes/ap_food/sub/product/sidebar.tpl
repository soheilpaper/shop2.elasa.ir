    ...
    {foreach from=$products item=product name=myLoop}
        <li class="clearfix media">
            ...
            <div class="product-container media" itemscope itemtype="http://schema.org/Product">
                 <a class="products-block-image img pull-left" href="{$product.link|escape:'html'}" title="{$product.legend|escape:html:'UTF-8'}"><img class="replace-2x img-responsive" src="{$link->getImageLink($product.link_rewrite, $product.id_image, 'food_small_default')|escape:'html'}" alt="{$product.name|escape:html:'UTF-8'}" />
                 </a>
