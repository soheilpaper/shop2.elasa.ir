...
<div class="shopping_cart_out {if $PS_CATALOG_MODE} header_user_catalog{/if}">
{/if}
	<div class="shopping_cart">
		<a href="{$link->getPageLink($order_process, true)|escape:'html':'UTF-8'}" title="{l s='View my shopping cart' mod='blockcart'}" rel="nofollow">
			<i class="icon-shopping-cart"></i><b>{l s='My Cart' mod='blockcart'}</b><span class="ajax_cart_quantity">{$cart_qties}</span>
		</a>
		{if !$PS_CATALOG_MODE}
