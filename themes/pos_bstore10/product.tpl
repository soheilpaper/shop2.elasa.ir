...
<div itemscope itemtype="http://schema.org/Product">
	<div class="primary_block row">
		...
		<div class="pb-center-column pb-right-column col-xs-12 col-sm-8 col-md-7">
			...
			<p id="availability_statut"{if !$PS_STOCK_MANAGEMENT || ($product->quantity <= 0 && !$product->available_later && $allow_oosp) || ($product->quantity > 0 && !$product->available_now) || !$product->available_for_order || $PS_CATALOG_MODE} style="display: none;"{/if}>
				...
				<span id="availability_value" class="label{if $product->quantity <= 0 && !$allow_oosp} label-danger{elseif $product->quantity <= 0} label-warning{else} label-success{/if}"  style="visibility: hidden; max-width: 1%;visibility: hidden;position: absolute;">{if $product->quantity <= 0}{if $PS_STOCK_MANAGEMENT && $allow_oosp}{$product->available_later}{else}{l s='This product is no longer in stock'}{/if}{elseif $PS_STOCK_MANAGEMENT} if}{l s=' '}{/if}</span>
								<span id="availability_value" class="label{if $product->quantity <= 0 && !$allow_oosp} label-danger{elseif $product->quantity <= 0} label-warning{else} label-success{/if}">{if $product->quantity <= 0}{if $PS_STOCK_MANAGEMENT && $allow_oosp}{$product->available_later}{else}{l s='This product is no longer in stock'}{/if}{elseif $PS_STOCK_MANAGEMENT}{l s='In stock'}{/if}</span>
              </p>
	...
	<div class="col-xs-12">
		<ul id="more_info_tabs" class="idTabs idTabsShort clearfix">
			...
			{if isset($HOOK_PRODUCT_TAB_CONTENT) && $HOOK_PRODUCT_TAB_CONTENT}{$HOOK_PRODUCT_TAB}{/if}
		</ul>
	</div>
	<div class="col-xs-12">
